...
namespace ASI.Basecode.WebApp
{
    ...
    internal partial class StartupConfigurer
    {
        ...
        private void ConfigureAuthorization()
        {
            ...
            var tokenProviderOptionsFactory = new TokenProviderOptionsFactory();
            var tokenValidationParametersFactory = new TokenValidationParametersFactory(this.Configuration);
